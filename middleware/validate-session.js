...
module.exports = function(req, res, next) {
    ...
    let sessionToken = req.headers.authorization; //the variable sessionToken is created to hold the token, which is pulled from the authorization header of the request coming in
